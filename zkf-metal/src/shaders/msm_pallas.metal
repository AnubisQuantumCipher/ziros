...
// ============================================================================
// Pallas MSM: Unified shader for Multi-Scalar Multiplication
// Includes: Fp field arithmetic, G1 projective curve ops, Pippenger kernels
//
// Pallas curve: y² = x³ + 5 over Fp (a=0, same Jacobian point ops as BN254)
// ============================================================================

// PALLAS BASE FIELD (Fp) — used for point coordinates
...
// Fp modulus (little-endian limbs)
constant Fp FQ_P = {{
    0x992d30ed00000001ULL,
    0x224698fc094cf91bULL,
...
constant Fp FQ_ONE = {{
    0x34786d38fffffffdULL,
    0x992c350be41914adULL,
    0xffffffffffffffffULL,
    0x3fffffffffffffffULL
}};

// -p^(-1) mod 2^64
constant uint64_t FQ_INV = 0x992d30ecffffffffULL;
