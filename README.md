...
- [What ZirOS Is](#what-ziros-is)
- [System Architecture](#system-architecture)
- [Full Technology Stack](#full-technology-stack)
- [Proving And Execution Surfaces](#proving-and-execution-surfaces)
- [Core ZirOS Subsystems](#core-ziros-subsystems)
- [Verified Boundary And Trust Model](#verified-boundary-and-trust-model)
- [Scientific, Engineering, And Mission Applications](#scientific-engineering-and-mission-applications)
- [Operator Entry Paths](#operator-entry-paths)
- [Performance, Hardware, And Storage](#performance-hardware-and-storage)
- [Quick Start](#quick-start)
- [Documentation And Truth Surfaces](#documentation-and-truth-surfaces)
- [Workspace And Technology Catalog](#workspace-and-technology-catalog)
- [License](#license)
...
- Start with `support-matrix.json`, `zkf-ir-spec/verification-ledger.json`, `.zkf-completion-status.json`, and `docs/CANONICAL_TRUTH.md`.
- Read `zkf-backends`, `zkf-backends-pro`, and `zkf-verify` for backend and verifier surfaces.
- Read `docs/VERIFIED_METAL_BOUNDARY.md` and `zkf-metal/proofs/*` for the GPU lane.
...
See [`LICENSE-BSL`](LICENSE-BSL) and the crate metadata for the current repository licensing posture.
