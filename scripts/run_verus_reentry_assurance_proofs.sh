...
proof_file="$alias_root/zkf-runtime/proofs/verus/reentry_assurance_verus.rs"

log() {
  printf '[verus-reentry-assurance] %s\n' "$*" >&2
}
...
log "Verifying theorem-first reentry assurance surface invariants"
