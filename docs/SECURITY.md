...
- Assurance classes: 137 `mechanized_implementation_claim`, 3 `bounded_check`, 3 `attestation_backed_lane`, 16 `model_only_claim`, 9 `hypothesis_carried_theorem`.
...
- Rows with non-empty `trusted_assumptions`: 3.
