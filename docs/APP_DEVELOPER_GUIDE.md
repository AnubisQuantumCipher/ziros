...
zkf app init my-zk-app --template real-gas-state --template-arg model=redlich-kwong
zkf app init my-zk-app --template navier-stokes-structured --template-arg cells=4
```
