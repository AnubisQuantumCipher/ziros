...
pub fn critical_hash_proof_surface(
    ...
    match op {
        SpecCriticalHashBlackBoxOp::Poseidon => match field {
            ...
            SpecCriticalHashFieldId::BabyBear if inputs_len == 4 && outputs_len == 4 => {
                Some(SupportedCriticalHashOp::PoseidonBabyBearWidth4)
            }
            SpecCriticalHashFieldId::Mersenne31 if inputs_len == 4 && outputs_len == 4 => {
                Some(SupportedCriticalHashOp::PoseidonMersenne31Width4)
            }
            _ => None,
        },
...
pub fn compute_hash_aux_witness(
    ...
    .or_else(|| {
        ...
        match (op_spec, field_spec, inputs_len) {
            ...
            (SpecCriticalHashBlackBoxOp::Poseidon, SpecCriticalHashFieldId::BabyBear, 4) => {
                Some(CriticalHashLoweringSemantics {
                    supported_op: SupportedCriticalHashOp::PoseidonBabyBearWidth4,
                    supported_inputs_len: 4,
                    supported_outputs_len: 4,
                    aux_witness_mode: CriticalHashAuxWitnessMode::ConstraintSolverDerived,
                })
            }
            (SpecCriticalHashBlackBoxOp::Poseidon, SpecCriticalHashFieldId::Mersenne31, 4) => {
                Some(CriticalHashLoweringSemantics {
                    supported_op: SupportedCriticalHashOp::PoseidonMersenne31Width4,
                    supported_inputs_len: 4,
                    supported_outputs_len: 4,
                    aux_witness_mode: CriticalHashAuxWitnessMode::ConstraintSolverDerived,
                })
...
mod tests {
    ...
    #[test]
    fn critical_hash_surface_admits_supported_poseidon_and_sha256_profiles() {
        assert_eq!(
            critical_hash_proof_surface(
        ...
        assert_eq!(
            critical_hash_proof_surface(
                SpecCriticalHashBlackBoxOp::Poseidon,
                SpecCriticalHashFieldId::BabyBear,
                4,
                4
            ),
            Some(SupportedCriticalHashOp::PoseidonBabyBearWidth4)
        ...
        assert_eq!(
            critical_hash_proof_surface(
                SpecCriticalHashBlackBoxOp::Poseidon,
                SpecCriticalHashFieldId::Mersenne31,
                4,
                4
            ),
            Some(SupportedCriticalHashOp::PoseidonMersenne31Width4)
